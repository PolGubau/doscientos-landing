...
<Image
  src={legacyGraph}
  alt="Visualización de integración de sistemas complejos a escala global - Proyecto IFCO Systems"
  width={1200}
...
<Image
  src={legacyShowcase}
  alt="Interfaz moderna para sistema de trazabilidad global a escala - Proyecto IFCO Systems"
  width={1200}
  class="rounded-2xl my-8 border bg-muted"
/>
