...
draft: false
faqs:
  - question: '¿Cuánto costó desarrollar Flatmatch?'
    answer: 'El MVP inicial de Flatmatch se construyó en 6 semanas con un equipo pequeño. El coste fue significativamente inferior al de un producto completo — exactamente la razón de ir con MVP primero.'
  - question: '¿Qué tecnologías usasteis en Flatmatch?'
    answer: 'React Native para la app móvil (iOS y Android desde una sola base de código), Supabase para el backend y la base de datos en tiempo real, y Vercel para la web de marketing. Un stack moderno que permitió velocidad de desarrollo y escalabilidad.'
  - question: '¿Cómo conseguisteis los primeros 500 usuarios sin publicidad?'
    answer: 'Activación orgánica en comunidades de estudiantes Erasmus y grupos universitarios donde el problema (encontrar piso) era real y urgente. El product-market fit hizo el resto: los propios usuarios lo compartían porque les resolvía algo que les importaba.'
---
...
Hasta que Lorenzo preguntó: _"¿Cuántos usuarios necesitamos para que el chat sea útil?"_
...
_¿Quieres ver Flatmatch en acción? [Prueba la demo](https://flatmatchweb.vercel.app/)_

_¿Tienes un proyecto similar? [Hablemos](/contact)_
