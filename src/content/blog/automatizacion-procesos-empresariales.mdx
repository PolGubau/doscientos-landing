...
leadMagnet:
  ...
  href: "/diagnostico-procesos?ref=recurso-checklist-automatizacion"
author: "doscientos"
faqs:
...
<Image src={autoDashboard} alt="Dashboard de automatización de procesos y control de flujos - Proyecto Optinergia" width={1200} class="rounded-2xl my-8 border bg-muted" />
