...
export const packs: Pack[] = [
  {
    ...
    metaTitle: "Web para barbería desde 290€ | Reservas online y galería | doscientos",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "Web para restaurante desde 290€ | Carta digital y reservas | doscientos",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "Web para gimnasio desde 290€ | Tarifas, horarios y altas | doscientos",
    metaDescription:
    ...
    faqs: [
      {
        ...
        answer: "Sí. Los cambios de tarifas y horarios entran dentro del mantenimiento mensual.",
      },
      {
  ...
  },
  {
    ...
    tagline: "Genera confianza y consigue nuevos clientes con una presencia online profesional.",
    ...
    faqs: [
      {
        ...
        answer:
          "Sí. El pack está pensado para profesionales de servicios —abogados, asesorías, consultorías y autónomos— y adaptamos los textos a tu actividad.",
      },
      {
  ...
  },
  {
    ...
    monthlyAmount: 34,
    bundledExtras: ["formularios-avanzados", "correo", "seo-local"],
    tagline: "Facilita que nuevos pacientes encuentren tu clínica y contacten contigo.",
    ...
    metaTitle: "Web para clínica desde 350€ | Capta pacientes online | doscientos",
    metaDescription:
    ...
    benefits: [
      {
        ...
        description:
          "Presentación de tu equipo y tratamientos para que el paciente sepa que está en buenas manos antes de llamar.",
        icon: "ShieldCheck",
      },
      {
...
export const extras: PackExtra[] = [
  ...
  },
  {
    ...
    installAmount: 50,
    monthlyAmount: 5,
    description: "Conecta tu calendario para que los clientes puedan reservar huecos disponibles.",
  },
  {
    slug: "instagram",
    title: "Instagram",
  ...
  },
  {
    ...
    installAmount: 30,
    monthlyAmount: 3,
    description: "Integra tu contenido social para reforzar confianza y actividad.",
  },
  {
    ...
    installAmount: 50,
    monthlyAmount: 3,
    description: "Muestra servicios, resultados, antes y después o trabajos destacados.",
  },
  {
    slug: "blog",
    ...
    installAmount: 100,
    monthlyAmount: 5,
    description: "Publica novedades, consejos o contenidos locales sin depender de desarrollo.",
  },
  {
    slug: "seo-local",
    title: "SEO Local",
    ...
    installAmount: 100,
    monthlyAmount: 10,
    description: "Optimización para aparecer mejor en Google Maps y búsquedas locales.",
  },
  {
    slug: "correo",
  ...
  },
  {
    ...
    installAmount: 50,
    monthlyAmount: 5,
    description: "Solicitudes con más campos, filtros, avisos y flujos de contacto adaptados.",
  },
  {
    slug: "whatsapp-auto",
    ...
    installAmount: 100,
    monthlyAmount: 10,
    description: "Automatiza el primer mensaje y ordena mejor las solicitudes entrantes.",
  },
  {
    slug: "chat-ia",
    title: "Chat IA",
    ...
    installAmount: 200,
    monthlyAmount: 15,
    description: "Responde automáticamente a preguntas frecuentes de los clientes.",
  },
  {
    slug: "reservas",
    ...
    installAmount: 300,
    monthlyAmount: 15,
    description: "Reserva citas directamente en tu web con un flujo propio y controlado.",
  },
];
...
export function getPackPricing(pack: Pack): PackPricing {
  ...
  const alaCarteInstall =
    basePlan.install.amount + bundled.reduce((sum, extra) => sum + extra.installAmount, 0);
  const alaCarteMonthly =
    basePlan.maintenance.amount + bundled.reduce((sum, extra) => sum + extra.monthlyAmount, 0);
