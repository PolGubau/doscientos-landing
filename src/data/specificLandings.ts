    ...
    stats: [
      {
        ...
        description: 'Una cola automatica ordena vencimientos por urgencia y responsable.',
      },
      {
        value: '1 semana',
      ...
      },
      {
        ...
        description: 'Cada renovacion tiene responsable, fecha, ultimo contacto y proxima accion.',
      },
    ],
    pains: [
      {
  ...
  },
  {
    ...
    stats: [
      ...
      },
      {
        value: '1 fuente',
        label: 'de verdad',
        description: 'Datos centralizados para que nadie pregunte cual era el archivo actualizado.',
      },
      {
        value: '24/7',
  ...
  },
  {
    ...
    stats: [
      ...
      },
      {
        ...
        description: 'Cada incidencia tiene estado, responsable y proxima accion clara.',
      },
      {
        value: 'rapido',
    ...
    pains: [
      ...
      },
      {
        ...
        description: 'Sin trazabilidad clara, el equipo pierde tiempo reconstruyendo que paso.',
      },
    ],
    solution: [
      {
    ...
    process: [
      {
        ...
        description: 'Probamos el flujo con un caso real para no diseñar desde teoria.',
      },
      {
  ...
  },
  {
    ...
    pains: [
      ...
      },
      {
        ...
        description: 'Sin cola automatica, las oportunidades aparecen cuando ya hay poco margen.',
      },
      {
        title: 'Las incidencias bloquean ventas',
        description: 'Documentacion, cambios y reclamaciones se mezclan con tareas comerciales.',
      },
    ],
    solution: [
      {
